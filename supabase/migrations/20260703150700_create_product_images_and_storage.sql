-- Migration: product_images table + product-images storage bucket
-- Safe to re-run (idempotent where possible)
--
-- Apply via Supabase Dashboard → SQL Editor → Run

-- ---------------------------------------------------------------------------
-- Prerequisite: updated_at helper (may already exist from main schema)
-- ---------------------------------------------------------------------------
...
-- RLS: disabled for MVP (same pattern as products, suppliers, etc.)
...
-- ---------------------------------------------------------------------------
-- Storage policies (MVP — open access; tighten before production)
-- ---------------------------------------------------------------------------
