...
export function ProductCard({ product, compact }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group block rounded-[20px] border border-gray-100 bg-card p-5 shadow-sm shadow-gray-200/40 transition-all hover:border-primary/20 hover:shadow-md"
    >
